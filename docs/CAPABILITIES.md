...
> Auto-generated on `2026-09-14 03:10:49 UTC`. Grounded in AST snapshot and benchmark gates.
...
| **Parsed Files** | `289` |
| **Packages** | `98` |
| **Discovered Structs** | `474` |
| **Discovered Interfaces** | `27` |
| **Functions & Methods** | `1245` |

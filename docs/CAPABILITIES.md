...
> Auto-generated on `2026-08-19 13:58:40 UTC`. Grounded in AST snapshot and benchmark gates.
...
| **Parsed Files** | `1978` |
| **Packages** | `263` |
| **Discovered Structs** | `5804` |
| **Discovered Interfaces** | `431` |
| **Functions & Methods** | `12166` |
| **Total Struct Fields** | `29195` |

...
**Generated:** Thu Aug 13 08:49:14 PM IST 2026
...
------------+--------------------------+-----------+----------+---------
 ...
 created_at | timestamp with time zone |           | not null | now()
Indexes:
    "cas_blocks_pkey" PRIMARY KEY, btree (block_hash)
...
### Critical Schema Checks
  ...
  - decision_revisions.decision_hash: ❌ MISSING
  - evidence_store.tenant_id: ❌ MISSING
...
## 9. Git Status
  ...
  - 8133bdd feat: complete Phase 2 – Topology Synthesis & Role Boundary Engine

---
✅ Truth Index generated: garuda_truth_index_20260813_204914.md
